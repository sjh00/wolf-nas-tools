...
def build_app_context() -> AppContext:
    ...
    context = AppContext(
        ...
        media_cleanup_service=services.media_cleanup_service,
        media_consistency_service=services.media_consistency_service,
        media_migrate_service=services.media_migrate_service,
