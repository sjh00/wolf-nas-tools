...
from app.infrastructure.external.tmdbv3api.as_obj import AsObj
...
class Movie(TMDb):
    ...
    def changes(self, movie_id, start_date="", end_date="", page=1):
        ...
        return self._get_obj(
            self._call(
                ...
                urlencode({"start_date": str(start_date), "end_date": str(end_date), "page": str(page)}),
            ),
            "changes",
        )
    ...
    def images(self, movie_id, include_image_language=""):
        ...
        backdrops) you can use the include_image_language parameter.
