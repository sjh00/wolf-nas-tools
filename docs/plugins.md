...
##### 1. 安装 wolfnas-chrome 容器

自动签到的浏览器自动化功能依赖 wolfnas-chrome 组件，安装与参数说明见 [安装指南 → 可选组件](installation.md#可选组件wolfnas-verify-与-wolfnas-chrome)。
...
2. 「网页自动化服务器」填写 wolfnas-chrome 容器的访问地址，如 `http://192.168.1.151:9850`
